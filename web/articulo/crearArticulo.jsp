                ...
                <div class="card text-white bg-dark">
                    ...
                    <div class="card-body">
                        <form action="ArticuloServlet?accion=guardar" method="POST">
                            ...
                            <div class="mb-3"><input class="form-control" type="text" name="articulo" required></div>
                            ...
                            <div class="mb-3"><input class="form-control" type="number" min="0.00" step="0.01" name="precio" required></div>
                            <div class="mb-3"><label>Existencias</label></div>
                            <div class="mb-3"><input class="form-control" type="number" min="0" step="1" name="existencia" required></div>
                            <div class="mb-3"><label>Stock Minimo</label></div>
                            <div class="mb-3"><input class="form-control" type="number" min="0" step="1" name="sMinimo" required></div>
                            <div class="mb-3"><label>Stock Máximo</label></div>
                            <div class="mb-3"><input class="form-control" type="number" min="0" step="1" name="sMaximo" required></div>
                            <div class="mb-3"><label>ID Categoria</label></div>
                            <div class="mb-3"><input class="form-control" type="text" name="idcategoria" required></div>
